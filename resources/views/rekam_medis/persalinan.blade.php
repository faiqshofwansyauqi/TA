    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Persalinan</h5>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-4 fw-bold" id="ModalInput">Input Persalinan</h1>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="menejemen" name="menejemen" required>
                                        ...
                                        <option value="Penegangan Tali Pusat Terkendali">Penegangan Tali Pusat Terkendali
                                        </option>
                                        <option value="Lintang/Oblique">Lintang/Oblique</option>
                    ...
                    <form id="editForm" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="datetime-local" class="form-control" id="edit_piasenta" name="piasenta">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control" id="edit_pendarahan" name="pendarahan"
                                        placeholder="Input Pendarahan Kala IV">
                                    <span class="input-group-text">cc</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control" id="edit_usia_hpht" name="usia_hpht"
                                        placeholder="input Usia HP HT">
                                    <span class="input-group-text">minggu</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="number" class="form-control" id="edit_berat_bayi" name="berat_bayi"
                                        placeholder="input Berat Bayi">
                                    <span class="input-group-text">gram</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="edit_cara_persalinan" name="cara_persalinan" required>
                                    <option value="">Pilih Cara Persalinan</option>
                                    <option value="Normal">Normal</option>
                                    <option value="Vakum">Vakum</option>
                                    <option value="Forseps">Forseps</option>
