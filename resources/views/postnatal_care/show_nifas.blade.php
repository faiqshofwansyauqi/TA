                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-anc" id="anc-table">
                                <thead>
                                    <tr>
                                        <th rowspan="3" class="align-middle text-center">Tanggal</th>
                                        <th rowspan="3" class="align-middle text-center">HARI KE/IF</th>
                                        ...
                                        <th rowspan="3" class="text-center align-middle">KLASIFIKASI</th>
                                        <th rowspan="3" class="text-center align-middle">TATA LAKSANA</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle text-center normal-header">Suhu <sup>*C</sup></th>
                                        <th class="align-middle text-center normal-header">Catatan di Buku KIA <sup>*</sup></th>
                                        ...
                                        <th class="align-middle text-center normal-header">PKM</th>
