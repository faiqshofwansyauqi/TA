...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        <div class="pagetitle">
            <h1 style="margin-bottom: 5px">Perawatan Selama Hamil</h1>
                            ...
                            <div class="card-body">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control" id="id_ibu" name="id_ibu" required>
                                        ...
                                        @foreach ($ibus as $rnca)
                                            <option value="{{ $rnca->ibu->id_ibu }}">{{ $rnca->ibu->nama_ibu }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12">
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            <div style="display: flex; justify-content: center;">
                                <a href="${viewUrl}" class="btn btn-table btn-sm btn-dark">
                                Detail
                                </a>
                            </div>
                            `;
