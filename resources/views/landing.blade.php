...
<head>
    ...
    <link href="{{ asset('assets/css/styles_landing.css') }}" rel="stylesheet">
</head>
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="address" type="text"
                                placeholder="Masukan alamat..." data-sb-validations="required" />
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="username" type="text"
                                placeholder="Masukan username..." data-sb-validations="required" />
