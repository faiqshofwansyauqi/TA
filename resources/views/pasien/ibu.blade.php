                        ...
                        <div class="card col-12">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="edit_pendidikan_ibu_suami" class="form-label">Pendidikan
                                            Ibu/Suami</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <label for="edit_pekerjaaan_ibu_suami" class="form-label">Pekerjaan
                                            Ibu/Suami</label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="edit_telp" name="telp"
                                            maxlength="13" pattern="[0-9]{1,13}" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">Submit</button>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <div style="display: flex; align-items: center;">
                            <button class="btn btn-sm btn-success edit-btn" data-id="${row.NIK}" data-bs-toggle="modal" data-bs-target="#modalEdit">
